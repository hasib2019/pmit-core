...
import {
  dpsFdrMigrationValidator,
  loanInfoMigrationValidator,
} from "../../../modules/migration/validators/samity-migration.validate";
...
import { dpsFdrMigrationValidatorForPost } from "../../migration/validators/dps-fdr-migration.validate";
...
export const applicationTypes: any = {
  ...
  dpsFdrMigration: dpsFdrMigrationValidatorForPost,
};
